...
export default function FramePage() {
  ...
  const [temperature, setTemperature] = useState(0); // Approximate with hue-rotate & sepia
  ...
  const getFilterStyle = () => {
    ...
    if (temperature > 0) {
      ...
      // Cool: add hue-rotate and slight invert
  ...
  // The frames are 1080x1350 for portrait and 1080x1080 for landscape usually, 
  // but we will render them responsive.
  const aspectRatio = frameType === 'PTR' ? '4/5' : frameType === 'LSC' ? '16/9' : '1/1';
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          {frameType === 'none' ? (
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px' }}>
              <button onClick={() => setFrameType('none')} className="btn-secondary" style={{ flex: 1, padding: '12px' }}>Change Frame</button>
            ...
            <div style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center' }}>
              <div 
                ...
                style={{ 
                  ...
                  width: '100%', 
                  maxWidth: '500px', 
                  aspectRatio: frameType === 'PTR' ? '4/5' : '4/3', // Default aspect ratios
                  overflow: 'hidden',
                  borderRadius: '0', // Frames usually don't have border radius in final export
                  background: '#ccc'
                }}
              >
                {/* User Photo */}
                ...
                <img 
                  ...
                  style={{ 
                    ...
                    height: '100%', 
                    objectFit: 'contain', 
                    pointerEvents: 'none' // Let clicks pass through if we ever add draggable photo
                  }} 
                />
              </div>
            </div>
          ...
          {frameType !== 'none' && (
            <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
              <button onClick={handleDownload} className="btn-secondary" style={{ flex: 1, padding: '16px' }}>
                <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                  Download
                </span>
              </button>
              <button onClick={handleShare} className="btn-primary" style={{ flex: 1, padding: '16px' }}>
                <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
